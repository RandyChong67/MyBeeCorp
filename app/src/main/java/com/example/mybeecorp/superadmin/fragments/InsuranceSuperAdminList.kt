 ...
 * Use the [InsuranceSuperAdminList.newInstance] factory method to
 * create an instance of this fragment.
 */
class InsuranceSuperAdminList : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_insurance_super_admin_list, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment InsuranceSuperAdminList.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(insuranceName: String, insuranceCompanyName: String) =
            InsuranceSuperAdminList().apply {
