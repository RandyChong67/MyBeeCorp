...
class ViewVehicleRecyclerAdapter(var vehicleList: List<Vehicle>, var insuranceList: List<Insurance_Bought>) :
    RecyclerView.Adapter<ViewVehicleRecyclerAdapter.ViewHolder>() {
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        init {
            itemView.setOnClickListener { v: View ->
                ...
                intent.putExtra("member_uid", insuranceList[position].user_uid)
                ...
                intent.putExtra("vehicle_uid", insuranceList[position].vehicle_uid)
