 ...
 * Use the [ViewDetailInsuranceItemCoveredCA.newInstance] factory method to
 * create an instance of this fragment.
 */
class ViewDetailInsuranceItemCoveredCA : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_view_detail_insurance_item_covered_c_a, container, false)
    ...
    companion object {
         ...
         * * @param itemCoveredPrice Parameter 3=2.
         * @return A new instance of fragment ViewDetailInsuranceItemCoveredCA.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(itemCoveredName: String,itemCoveredPrice: String) =
            ViewDetailInsuranceItemCoveredCA().apply {
