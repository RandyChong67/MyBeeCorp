...
class MemberMyProfile : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_member_my_profile)
        ...
        saveBtn.setOnClickListener{
            if(changedPhoto == "Yes") {
                ...
                val oldPic = findViewById<TextView>(R.id.oldPicUrl3)
    ...
    private fun loadProfile(userID:String){
        ...
        val origBankPINET = findViewById<TextView>(R.id.hiddenOrigBankPIN3)
        val oldPicUrl = findViewById<TextView>(R.id.oldPicUrl3)
        ...
        var origBankNumET = findViewById<TextView>(R.id.member_hiddenBankNum)
                    ...
                    for(i in snapshot.children){
                        if(i.child("user_uid").value.toString() == userID){
                            if(i.child("user_avatar").value.toString() != "") {
                                if(!this@MemberMyProfile.isFinishing) {
    ...
    private fun updateProfile(userID:String, photoUrl:String){
        ...
        val hiddenBankPin = findViewById<TextView>(R.id.hiddenOrigBankPIN3)
        var updateBankPIN = hiddenBankPin.text.toString()
        val hiddenBankNum = findViewById<TextView>(R.id.member_hiddenBankNum)
