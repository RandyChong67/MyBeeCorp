...
class EditInsuranceSuperAdmin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_edit_insurance_super_admin)
        ...
        var ref = instance.getReference("Item_Covered").child(insurance_uid!!).addValueEventListener(object:
            ValueEventListener {
            ...
            checkbox.setOnClickListener {
                ...
                if(!isChecked){
                    if(insuranceCovered.containsKey(checkbox.tag as String)){
                        ...
                        Log.e("Error","Unable to find the insurance item covered.")
                    }
                }
                else{
    ...
    private fun saveToFirebaseDatabase() {
        val builder: android.app.AlertDialog.Builder = android.app.AlertDialog.Builder(this@EditInsuranceSuperAdmin)
        ...
        builder.setPositiveButton("Yes") { dialog, which ->
            ...
            if (insurance_uid !=null){
                reference = database.getReference("/Motor_Insurance")
                //val insurance = DbInsurance(insurance_uid!!, insurance_name,insurance_company,insurance_class,insurance_status)
                var data = mutableMapOf<String,Any>("insurance_name" to insurance_name, "insurance_company" to insurance_company,
    ...
    //Get Ins Company Data from firebase
        ...
        companyRef.addValueEventListener(object: ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                if(snapshot.exists()){
                    ...
                    val companyAdapter = ArrayAdapter<String>(this@EditInsuranceSuperAdmin, android.R.layout.simple_spinner_item, company)
