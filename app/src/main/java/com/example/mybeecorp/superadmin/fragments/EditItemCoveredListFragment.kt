 ...
 * Use the [EditItemCoveredListFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class EditItemCoveredListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_edit_item_covered_list, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment EditItemCoveredListFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(editItemCoveredName: String, editItemCoveredPrice: String) =
            EditItemCoveredListFragment().apply {
