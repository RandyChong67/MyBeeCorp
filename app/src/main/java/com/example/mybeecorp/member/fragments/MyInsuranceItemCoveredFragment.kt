 ...
 * Use the [MyInsuranceItemCoveredFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class MyInsuranceItemCoveredFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var view = inflater.inflate(R.layout.fragment_my_insurance_item_covered, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment MyInsuranceItemCoveredFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(itemCoveredName: String, itemCoveredPrice: String) =
            MyInsuranceItemCoveredFragment().apply {
